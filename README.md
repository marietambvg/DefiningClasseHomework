...
a)	Create an instance of the GSM class.
b)	Add few calls.
c)	Display the information about the calls.
d)	Assuming that the price per minute is 0.37 calculate and print the total price of the calls in the history. 
e)	Remove the longest call from the history 
and calculate the total price again.
f)	Finally clear the call history and print it. 
